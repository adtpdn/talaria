...
sprint: beta
category: TESTING
description: "Install and configure GUT (Godot Unit Test) framework for automated testing."
---
## Overview

Install and configure the GUT (Godot Unit Test) framework for automated testing.
